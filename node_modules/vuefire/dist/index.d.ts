 ...
 */
declare function useDatabaseList<T = unknown>(reference: MaybeRefOrGetter<DatabaseReference | Query>, options?: UseListOptions): _RefDatabase<VueDatabaseQueryData<T>>;
/**
 ...
 * @param options - optional options
 */
declare function useDatabaseObject<T = unknown>(reference: MaybeRefOrGetter<DatabaseReference>, options?: UseObjectOptions): _RefDatabase<VueDatabaseDocumentData<T> | undefined>;
/**
