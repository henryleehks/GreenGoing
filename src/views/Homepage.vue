...
<template>
    <columns class="flex flex-col flex-1">
        ...
        <div class="flex flex-shrink-0 h-80 md:h-96">
            <div id="user-input-area" class="w-full h-auto md:h-auto">
                <div id="homepage-carousel" class=" z-0 w-full content-center " data-carousel="slide">
                    <div class="relative z-0 h-80 overflow-hidden w-full rounded-t-xl md:h-96">
                        ...
                        <div class="hidden duration-[4000ms] ease-in-out" data-carousel-item>
                            <img src="../assets/home_bg1.jpg" class=" object-fill relative block w-full shadow-xl"
                                alt="Gardens By the Bay">
                        </div>

                        <div class="hidden duration-[4000ms] ease-in-out" data-carousel-item>
                            <img src="../assets/home_bg2.jpeg" class="object-fill relative block w-full shadow-xl"
                                alt="Henderson Waves">
                        </div>

                        <div class="hidden duration-[4000ms] ease-in-out" data-carousel-item>
                            <img src="../assets/home_bg3.jpg" class="object-fill relative block w-full shadow-xl"
                                alt="Changi Jewel">
                        </div>

                        <div class="hidden duration-[4000ms] ease-in-out" data-carousel-item>
                            <img src="../assets/home_bg4.jpg" class=" object-fill relative block w-full shadow-xl"
                                alt="Kampung Admirality">
                        </div>

                        <div class="hidden duration-[4000ms] ease-in-out" data-carousel-item>
                            <img src="../assets/home_bg5.jpg" class=" object-fill relative block w-full shadow-xl"
                                alt="Cycling by Marina Bay">
                        </div>
                    </div>
                </div>

                    <div id="user-input-box" class=" absolute grid grid-rows-3 h-screen rounded-xl z-1 p-1 drop-shadow-md inset-x-0 top-16 w-2/3 md:w-1/3">
                        ...
                        <div id="traveller-date-input" class="grid place-items-center row-start-1 grid-cols-4">
                            ...
                            <div id="daterange-input" date-rangepicker class="flex place-items-center col-span-4">
                                <div class="relative" id="input-start-date">
                                    ...
                                    <input datepicker data-date-format="dd/mm/yyyy" datepicker-autohide name="start" type="text"
                                        class="bg-gray-50 border border-gray-300 text-emerald-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div class="relative" id="input-end-date">
                                    ...
                                    <input datepicker data-date-format="dd/mm/yyyy" datepicker-autohide name="end" type="text"
                                        class="bg-gray-50 border border-gray-300 text-emerald-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div id="travellers-pax-input" class="grid place-items-center row-start-2 grid-cols-6">
                            ...
                            <input type="number" id="visitors" min="1" max="12"
                                class="bg-gray-50 border border-gray-300 text-emerald-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 col-span-2 w-full"
        ...
        <div class="flex flex-shrink-0 flex-1">
            <div id="featured-listings" style="background-color: bisque;" class="px-6 pt-2 pb-12 mb-24 w-full h-full">
                ...
                <div id="header-featured-listings" class="px-6 my-5">
                    ...
                    <p class="font-bold text-lg text-gray-500 lg:text-xl dark:text-gray-400 text-center">Life is all about
                        trying
                        new experiences!</p>
                </div>

                <div id="PageContent"
                    class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 place-items-center content-center">
                    ...
                    <div id="item-3-card"
                        ...
                        <div class="px-5 pb-5">
                            <a href="#">
                                <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Gardens By
                                    the Bay</h5>
                            </a>
                            <div class="flex items-center mt-2.5 mb-5">
                                <img class="w-4 h-4" src="img/color_tree.png">
