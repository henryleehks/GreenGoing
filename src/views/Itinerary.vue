                ...
                <div id="itinerary-search" class="container justify-center absolute left-0 mt-40 md:mt-45 lg:mt-40 xl:mt-40">
                    ...
                    <form class="ml-10 mb-5 w-1/3">
                        ...
                        <div class="relative">
                            ...
                            <!-- submit button -->
                            <button type="submit" v-on:click="SearchAllDocuments()" class="text-white absolute right-1 bottom-1.5 bg-neutral-400 hover:bg-neutral-500 focus:ring-4 focus:outline-none focus:ring-[#50A060] font-xsmall rounded-md text-xs px-1 py-1">Search</button>
                        </div>
                    </form>
