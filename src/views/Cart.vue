...
<template>
    ...
    <div id="mySidenav"
        ...
        <!--         <a href="javascript:void(0)" class="closebtn" onclick="closeNav()" style="padding: 8px 8px 8px 32px; text-decoration: none; font-size: 25px; color: #818181; display: block; transition: 0.3s;">&times;</a>
            ...
            <div class="row">
                ...
                <div class="col-lg">
                    ...
                    <div id="content" class="hide">
                        <div class="ms-card ms-fill" style="padding: 10px;">
    ...
    <div id="main"
        ...
        <div id="PageContent" class="container flex flex-1 justify-center md:justify-start "
                ...
                <div class="px-5 pb-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="protoreview.html"
                            onclick="sendoverrev(1,'img/a.jpg','Wild Wild Ticket','My House',5,'NIL') ; location.href = 'protoreview.html';">
                            <button
                                ...
                                onclick="sendoverrev(1,'img/a.jpg','Wild Wild Ticket','My House',5,'NIL') ; location.href = 'protoreview.html';">View
                                More</button>
                        </a>
                        &nbsp
                        <button
                            class="text-black bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800"
                            onclick="addToCart(1,'Wild Wild Ticket', 10.00,'img/a.jpg','Adult')">Add Cart</button>
                    </div>
                </div>
            </div>
            &nbsp
            ...
            <div id="item2"
                ...
                <div class="px-5 pb-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        &nbsp
                        <a href="protoreview.html"
                            onclick="sendoverrev(2,'img/b.png','Bird Paradise','My House',5,'NIL') ; ">
                            <button
                                class="text-black bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800"
                        ...
                        <button
                            class="text-black bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800"
                            onclick="addToCart(2,'Bird Paradise', 20.00,'img/b.png','Adult')">Add Cart</button>
                    </div>
                </div>
            </div>
            &nbsp
            ...
            <div id="item3"
                ...
                <div class="px-5 pb-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        &nbsp
                        <a href="protoreview.html"
                            onclick="sendoverrev(3,'img/c.jpg','Gardens Nina Buay','My House',5,'NIL') ; location.href = 'protoreview.html';">
                            <button
                                class="text-black bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800"
                                onclick="sendoverrev(3,'img/c.jpg','Gardens Nina Buay','My House',5,'NIL') ; location.href = 'protoreview.html';">View
                                More</button>
                        </a>
                        &nbsp
                        <button
                            class="text-black bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800"
                            onclick="addToCart(3,'Gardens Nina Buay', 50.00,'img/c.jpg','Adult')">Add Cart</button>
                    </div>
                </div>
            </div>
            &nbsp
            ...
            <div id="item4"
                ...
                <div class="px-5 pb-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        &nbsp
                        <a href="protoreview.html"
                            onclick="sendoverrev(4,'img/d.jpg','Changi Jewel Tour','My House',5,'NIL') ; location.href = 'protoreview.html';">
                            <button
                                class="text-black bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800"
                                onclick="sendoverrev(4,'img/d.jpg','Changi Jewel Tour','My House',5,'NIL') ; location.href = 'protoreview.html';">View
                                More</button>
                        </a>
                        &nbsp
                        <button
                            class="text-black bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800"
                            onclick="addToCart(4,'Changi Jewel Tour', 90.00,'./img/d','Adult')">Add Cart</button>
                    </div>
                </div>
            </div>
            &nbsp
            ...
            <div id="item5"
                class="w-full max-w-sm bg-green-100 border border-gray-200 rounded-xl shadow light:bg-gray-800 dark:border-gray-700 object-cover">
                <a href="#">
                    <img class="rounded-xl object-cover" src="img/e.jpeg" alt="product image" />
                </a>

                <div class="px-5 pb-5">
                    <a href="#">
                        <h5 class="text-2xl font-semibold tracking-tight text-gray-900 light:text-white">Garden Walk
                        </h5>
                    </a>
                    <div class="flex items-center mt-2.5 mb-5">
                        <img class="w-4 h-4" src="img/color_tree.png">
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-3xl font-bold text-gray-900 light:text-black">$15</span>
                        &nbsp
                        <a href="protoreview.html"
                            onclick="sendoverrev(5,'img/e.jpeg','Garden Walk','My House',5,'NIL') ; location.href = 'protoreview.html';">
                            <button
                                class="text-black bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800"
                                onclick="sendoverrev(5,'img/e.jpeg','Garden Walk','My House',5,'NIL') ; location.href = 'protoreview.html';">View
                                More</button>
                        </a>
                        &nbsp
                        <button
                            class="text-black bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800"
                            onclick="addToCart(5,'Garden Walk', 15.00,'img/e.jpeg','Adult')">Add Cart</button>
                    </div>
                </div>
            </div>
            &nbsp
            ...
            <div id="item6"
                class="w-full max-w-sm bg-green-100 border border-gray-200 rounded-xl shadow light:bg-gray-800 dark:border-gray-700 object-cover">
                <a href="#">
                    <img class="rounded-xl object-cover" src="img/f.jpg" alt="product image" />
                </a>

                <div class="px-5 pb-5">
                    <a href="#">
                        <h5 class="text-2xl font-semibold tracking-tight text-gray-900 light:text-white">MBS Tour
                        </h5>
                    </a>
                    <div class="flex items-center mt-2.5 mb-5">
                        <img class="w-4 h-4" src="img/color_tree.png">
                        ...
                        <img class="w-4 h-4" src="img/grey_tree.png">
                        <span
                            class="bg-light green-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">2.0</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-3xl font-bold text-gray-900 light:text-black">$98</span>
                        &nbsp
                        <a href="protoreview.html" onclick="sendoverrev(6,'img/f.jpg','MBS Tour','My House',2,'NIL') ; ">
                            <button
                                class="text-black bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800"
                                onclick="sendoverrev(6,'img/f.jpg','MBS Tour','My House',2,'NIL') ; ">View More</button>
                        </a>
                        &nbsp
                        <button
                            class="text-black bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800"
                            onclick="addToCart(6,'MBS Tour', 98.00,'img/f.jpg','Adult')">Add Cart</button>
                    </div>
                </div>
            </div>
            &nbsp
            ...
            <div id="item7"
                class="w-full max-w-sm bg-green-100 border border-gray-200 rounded-xl shadow light:bg-gray-800 dark:border-gray-700 object-cover">
                <a href="#">
                    <img class="rounded-xl object-cover" src="img/g.jpg" alt="product image" />
                </a>

                <div class="px-5 pb-5">
                    <a href="#">
                        <h5 class="text-2xl font-semibold tracking-tight text-gray-900 light:text-white">Universal
                        </h5>
                    </a>
                    <div class="flex items-center mt-2.5 mb-5">
                        <img class="w-4 h-4" src="img/color_tree.png">
                        ...
                        <img class="w-4 h-4" src="img/grey_tree.png">
                        <span
                            class="bg-light green-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">1.0</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-3xl font-bold text-gray-900 light:text-black">$70</span>
                        &nbsp
                        <a href="protoreview.html"
                            onclick="sendoverrev(7,'img/g.jpg','Universal','My House',1,'NIL') ; location.href = 'protoreview.html';">
                            <button
                                class="text-black bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800"
                                onclick="sendoverrev(7,'img/g.jpg','Universal','My House',1,'NIL') ; location.href = 'protoreview.html';">View
                                More</button>
                        </a>
                        &nbsp
                        <button
                            class="text-black bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800"
                            onclick="addToCart(7,'Universal', 70.00,'img/g.jpg','Adult')">Add Cart</button>
                    </div>
                </div>
            </div>
            &nbsp
            ...
            <div id="item8"
                class="w-full max-w-sm bg-green-100 border border-gray-200 rounded-xl shadow light:bg-gray-800 dark:border-gray-700 object-cover">
                <a href="#">
                    <img class="rounded-xl object-cover" src="img/h.jpg" alt="product image" />
                </a>

                <div class="px-5 pb-5">
                    <a href="#">
                        <h5 class="text-2xl font-semibold tracking-tight text-gray-900 light:text-white">Merlion
                        </h5>
                    </a>
                    <div class="flex items-center mt-2.5 mb-5">
                        <img class="w-4 h-4" src="img/color_tree.png">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        &nbsp
                        <a href="protoreview.html"
                            onclick="sendoverrev(8,'img/h.jpg','Merlion','My House',3,'NIL') ; location.href = 'protoreview.html';">
                            <button
                                class="text-black bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800"
                                onclick="sendoverrev(8,'img/h.jpg','Merlion','My House',3,'NIL') ; location.href = 'protoreview.html';">View
                                More</button>
                        </a>
                        &nbsp
                        <button
                            class="text-black bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800"
                            onclick="addToCart(8,'Merlion', 50.00,'img/h.jpg','Adult')">Add Cart</button>
                    </div>
                </div>
            </div>
...
function addToCart(ID, productName, price, imgurl, type) {
...
function sendoverrev(ID, imgurl, Name, address, ratings, misc) {
    let reviewcache = []
