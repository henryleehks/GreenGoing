...
body {
    ...
    align-items: center;
    min-height: 100vh;
    background: url('../../img/homepage background 3.jpg') no-repeat;
...
.wrapper {
    ...
    border: 2px solid #fff;
    border-radius: 20px;
    box-shadow: 0 0 30px rgba(8, 121, 241, 0.5);
    backdrop-filter: blur(20px);
    display: flex;
    ...
    <script>
        function initGoogleSignIn() {
                ...
                function signOut(authID) {
                    ...
                    // May need to configure the redirect after logging out
                    document.location.href = "https://www.google.com/accounts/Logout?continue=https://appengine.google.com/_ah/logout?continue=http://localhost/greengoing/google-login-api";
